 ...
 *
 ***************************************************************************/
JellySpeaker.PluginIconManagerInputer = function(){
...
JellySpeaker.PluginIconManagerInputer.EVENT_LOADSEARCHDATA = 'loadsearchdata';
 ...
 *
 **************************************************/
JellySpeaker.PluginIconManagerInputer.prototype.addEventListener               = function(element, eventName, eventFunc){ return this.event.addEventListener(element, eventName, eventFunc); };
JellySpeaker.PluginIconManagerInputer.prototype.addEventListenerByEventName    = function(eventName, eventFunc){ this.event.addEventListenerByEventName(eventName, eventFunc); return this; };
JellySpeaker.PluginIconManagerInputer.prototype.hasEventListener               = function(element, eventName, eventFunc){ return this.event.hasEventListener(element, eventName, eventFunc); };
JellySpeaker.PluginIconManagerInputer.prototype.hasEventListenerByEventName    = function(eventName, eventFunc){ return this.event.hasEventListenerByEventName(eventName, eventFunc); };
JellySpeaker.PluginIconManagerInputer.prototype.hasEventListenerByEventFunc    = function(eventFunc){ return this.event.hasEventListenerByEventFunc(eventFunc); };
JellySpeaker.PluginIconManagerInputer.prototype.removeEventListener            = function(element, eventName, eventFunc){ return this.event.removeEventListener(element, eventName, eventFunc); };
JellySpeaker.PluginIconManagerInputer.prototype.removeEventListenerByEventName = function(eventName, eventFunc){ return this.event.removeEventListenerByEventName(eventName, eventFunc); };
JellySpeaker.PluginIconManagerInputer.prototype.removeEventListenerByEventFunc = function(eventFunc){ return this.event.removeEventListenerByEventFunc(eventFunc); };
JellySpeaker.PluginIconManagerInputer.prototype.execEventListener              = function(element, eventName, event){ return this.event.execEventListener(element, eventName, event); };
JellySpeaker.PluginIconManagerInputer.prototype.execEventListenerByEventName   = function(eventName, event){ return this.event.execEventListenerByEventName(eventName, event); };



JellySpeaker.PluginIconManagerInputer.prototype.setup = function(parent){
    var that = this;
    ...
    //- Setup Command
    var icon = new JellySpeaker.Icon(JellySpeaker.PluginIconManager.COMMAND_NAME_FOR_OPEN).setCommand(function(parameter){
        popman.pop(JellySpeaker.PluginIconManager.POP_ICON_MANAGER);
    });
    ...
    ready(function(){
         ...
         *************************/
        if (popman.has(JellySpeaker.PluginIconManager.POP_ICON_MANAGER)){
            that.makeInputer();
        }else{
            parent.addEventListenerByEventName(JellySpeaker.PluginIconManager.EVENT_JELLYICONMANAGER_SETUP, function(){
                that.makeInputer();
            });
        }
         ...
         * Make Pop Event
         *************************/
        parent.addEventListenerByEventName(JellySpeaker.PluginIconManager.EVENT_JELLYICONMANAGER_AFTERPOP, function(){
...
JellySpeaker.PluginIconManagerInputer.prototype.start = function(){

};
JellySpeaker.PluginIconManagerInputer.prototype.end = function(){

};
JellySpeaker.PluginIconManagerInputer.prototype.dispose = function(){
...
JellySpeaker.PluginIconManagerInputer.prototype.makeInputer = function(){
    var that = this;
    ...
    var popElement = popman.getPop(JellySpeaker.PluginIconManager.POP_ICON_MANAGER).element;
 ...
 * CACHE SEARCH DATA
 *****/
JellySpeaker.PluginIconManagerInputer.prototype.setLoadData = function(func){
...
JellySpeaker.PluginIconManagerInputer.prototype.loadSearchData = function(){
...
JellySpeaker.PluginIconManagerInputer.prototype.search = function(word, resultId){
    var that = this;
    var parent = this.parent;
    var boxman = parent.boxman;
    var popman = parent.popman;
...
JellySpeaker.PluginIconManagerInputer.prototype.clearInputSearch = function(resultId){
    var that = this;
    var parent = this.parent;
    var boxman = parent.boxman;
    var popman = parent.popman;
...
JellySpeaker.PluginIconManagerInputer.prototype.inputSearch = function(word, repoMap){
    if (repoMap){
