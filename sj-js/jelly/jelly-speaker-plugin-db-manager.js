 ...
 *
 ***************************************************************************/
JellySpeaker.PluginDBManager = function(){
    this.name = '';
    this.parent = null;
    this.statusSetuped = false;
};
JellySpeaker.PluginDBManager.SYSTEM_ICON_ID_TO_OPEN = 'open-plugin-db-manager';
JellySpeaker.PluginDBManager.USER_ICON_ID_TO_OPEN = 'open-db-manager';
JellySpeaker.PluginDBManager.POP_MANAGER = 'pop-db-manager';



JellySpeaker.PluginDBManager.prototype.setup = function(parent){
    var that = this;
    ...
    parent.setupSystemIcon([
        new JellySpeaker.Icon(JellySpeaker.PluginDBManager.SYSTEM_ICON_ID_TO_OPEN).setCommand(function(){
            popman.pop(JellySpeaker.PluginDBManager.POP_MANAGER);
        })
    ]);
    /** User Icon **/
    parent.setupUserIcon([
        new JellySpeaker.Icon(JellySpeaker.PluginDBManager.USER_ICON_ID_TO_OPEN).setTitle('DB 관리자').setHTML('🗄️').setCommand(JellySpeaker.PluginDBManager.SYSTEM_ICON_ID_TO_OPEN).setRunner([
        ]),
    ]);
    /** Make Component **/
    ready(function(){
...
JellySpeaker.PluginDBManager.prototype.start = function(){

};
JellySpeaker.PluginDBManager.prototype.end = function(){

};
JellySpeaker.PluginDBManager.prototype.dispose = function(){
 ...
 *
 **************************************************/
JellySpeaker.PluginDBManager.prototype.makePopForDBManager = function(){
    var that = this;
    var parent = this.parent;
    var boxman = parent.boxman;
    var popman = parent.popman;
    ...
    var popElementForManager = popman.add(popman.new({
        id: JellySpeaker.PluginDBManager.POP_MANAGER,
        exp: '95%',
        closebyesc: true,
...
JellySpeaker.PluginDBManager.prototype.executeQuery = function(query, callbackWhenSuccess){
