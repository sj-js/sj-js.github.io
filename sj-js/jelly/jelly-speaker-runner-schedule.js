 ...
 *
 **************************************************/
JellySpeaker.ScheduleRunner = function(object){
    this.type = JellySpeaker.TYPE_RUNNER_SCHEDULE;
    this.parent = null;
...
JellySpeaker.ScheduleRunner.prototype.init = function(object){
    for (var key in object)
        this[key]= object[key];
    return this;
};
JellySpeaker.ScheduleRunner.prototype.setup = function(parent){
    return this;
};
JellySpeaker.ScheduleRunner.prototype.getExpression = function(){
    if (this.timeManExp)
        return this.timeManExp;
    return 'cycle(' +this.cycleTime+ ')';
};
JellySpeaker.ScheduleRunner.prototype.getRemainingTime = function(){
    var result = 0;
    return result;
};
 ...
 *
 ****************************************************************************************************/
JellySpeaker.prototype.startWorkProcess = function(){
    var that = this;
    var stackToNextWork = [];
    var workItem;
...
JellySpeaker.prototype.addWork = function(workItem){
