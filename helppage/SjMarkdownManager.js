...
SjMarkdownManager.prototype.setPublicDirRawFilesMap = function(publicDirRawFilesMap){
    this.publicDirRawFilesMap = publicDirRawFilesMap;
    return this;
};

SjMarkdownManager.prototype.setLibraryNameMarkdownPathsMap = function(libNameMdPathsMap){
    var that = this;
    this.libraryNameMarkdownPathsMap = libNameMdPathsMap;
    this.libraryNameResolvedMarkdownPathsMap = this.resolveAllPath(libNameMdPathsMap);
    this.markdownFileRange = this.concatAllValue(libNameMdPathsMap);
...
SjMarkdownManager.prototype.generateDevelopWebpackPluginList = function(TEMP_PATH){
    var resultList = [];
    var copyWebpackPluginList = this.generateCopyWebpackPluginFromRawFiles(this.publicDirRawFilesMap);
    ...
    for (var libName in libraryNameResolvedMarkdownPathsMap){
        ...
        for (var i=0; i<markdownFilePathListByLibName.length; i++){
            ...
            that.htmlWebpackPluginList.push(new HtmlWebpackPlugin({
                filename: './' + libName + '/' + mdFileName + '.html',
...
SjMarkdownManager.prototype.updateSjMarkdown = function(){
    var that = this;
    // var libraryNameResolvedMarkdownPathsMap = that.libraryNameResolvedMarkdownPathsMap;
    var libraryNameMarkdownPathsMap = that.libraryNameMarkdownPathsMap;
